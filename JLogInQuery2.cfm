...
<cfif StructKeyExists(url, "DeleteSupervisorTrail")>
	<cfif URL.DeleteSupervisorTrail IS "Y">
		<cfinclude template="queries/del_DeleteSupervisorTrail.cfm">
	</cfif>
</cfif>
<cfinclude template="queries/qry_QLogInQuery.cfm">
