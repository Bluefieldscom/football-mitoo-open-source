...
<cfquery name="QInsrtMisc003" datasource="#request.DSN#" >
	...
	VALUES
		...
		<cfqueryparam value = #QMisc003.TeamID# cfsqltype="CF_SQL_INTEGER" maxlength="8">, 
		<cfqueryparam value = #QMisc003.OrdinalID# cfsqltype="CF_SQL_INTEGER" maxlength="8">,
		<cfqueryparam value = #QMisc003.ThisMatchNoID# cfsqltype="CF_SQL_INTEGER" maxlength="8">, 
		<cfqueryparam value = #QMisc003.NextMatchNoID# cfsqltype="CF_SQL_INTEGER" maxlength="8">)
</cfquery>
...
<cfelse>
	...
	<cfstoredproc procedure="insert_constitution" datasource="zmast">
		...
		<cfprocparam variable="teamid"	 		type="In" 	value=#QMisc003.TeamID# 			cfsqltype="cf_sql_integer">
		<cfprocparam variable="ordinalid" 		type="In" 	value=#QMisc003.OrdinalID# 		cfsqltype="cf_sql_integer">
		<cfprocparam variable="thismatchnoid" 	type="In" 	value=#QMisc003.ThisMatchNoID# 	cfsqltype="cf_sql_integer">
		<cfprocparam variable="nextmatchnoid" 	type="In" 	value=#QMisc003.NextMatchNoID# 	cfsqltype="cf_sql_integer">
