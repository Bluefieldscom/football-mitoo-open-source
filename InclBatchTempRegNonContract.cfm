	...
	<CFLOOP index="I" from="2" to="500" step="1">
		...
		<cfif PerfectLine IS "Yes">
			...
			<cfif QRegisterF.RecordCount IS 1>
				<cfinclude template="queries/upd_RegisterFA.cfm">
			<cfelse>
				<cfset PerfectLine = "No" >
		...
		<cfif PerfectLine IS "Yes">
			<cfset ErrorText = '#ErrorText# <span class="pix10boldgreen">now a Non-Contract player for #QRegisterF.TeamName#<BR><BR></span>'>
