...
<cfoutput>
	<table border="1">
		...
		<tr> <td width="100%"  colspan="#ThisColSpan#" align="center" valign="top"><strong>#QGetTeam.ClubName#: Players with Expired Registrations on #DateFormat(Now(),'DD MMMM YYYY')#</strong></td></tr>
	</table>
</cfoutput>
<cfset SortSeq = "Name">
