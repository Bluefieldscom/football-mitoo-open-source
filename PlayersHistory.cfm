...
<cfelse>
	...
	<table WIDTH="100%" border="1" cellspacing="0" cellpadding="5" class="loggedinScreen">
		...
		<tr>
			...
			<td><a href="SeeGoalscorers.cfm?LeagueCode=#LeagueCode#"><span class="pix10">see Player: Goals Scored</span></a></td>
		</tr>
		</cfoutput>
	</table>
			...
			<tr>
				...
				<cfelse>
					...
					<cfif HideScore IS "Yes" AND ListFind("Yellow",request.SecurityLevel) >
						<td colspan="2" align="center"><span class="pix10grey">Played</span></td>
					<cfelse>
