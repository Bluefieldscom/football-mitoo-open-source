...
--->
<cfquery name="gettables" datasource="fm2004">
	show tables
</cfquery>

<cfloop query="gettables">
	<cfset tablename = #tables_in_fm2004#>
	<cfquery name="getit" datasource="fm2004">
		explain #tablename#
	</cfquery>
	<cfloop query="getit">
		<cfif #getit.null# IS "YES">
			<cfquery name="changeit" datasource="fm2004">
				UPDATE #tablename#
