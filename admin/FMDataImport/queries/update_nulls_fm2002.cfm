...
--->
<cfquery name="gettables" datasource="fm2002">
	show tables
</cfquery>

<cfloop query="gettables">
	<cfset tablename = #tables_in_fm2002#>
	<cfquery name="getit" datasource="fm2002">
		explain #tablename#
	</cfquery>
	<cfloop query="getit">
		<cfif #getit.null# IS "YES">
			<cfquery name="changeit" datasource="fm2002">
				UPDATE #tablename#
