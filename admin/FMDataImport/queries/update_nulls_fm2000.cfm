...
--->
<cfquery name="gettables" datasource="fm2000">
	show tables
</cfquery>

<cfloop query="gettables">
	<cfset tablename = #tables_in_fm2000#>
	<cfquery name="getit" datasource="fm2000">
		explain #tablename#
	</cfquery>
	<cfloop query="getit">
		<cfif #getit.null# IS "YES">
			<cfquery name="changeit" datasource="fm2000">
				UPDATE #tablename#
