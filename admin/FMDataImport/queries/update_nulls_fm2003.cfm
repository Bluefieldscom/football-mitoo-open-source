...
--->
<cfquery name="gettables" datasource="fm2003">
	show tables
</cfquery>

<cfloop query="gettables">
	<cfset tablename = #tables_in_fm2003#>
	<cfquery name="getit" datasource="fm2003">
		explain #tablename#
	</cfquery>
	<cfloop query="getit">
		<cfif #getit.null# IS "YES">
			<cfquery name="changeit" datasource="fm2003">
				UPDATE #tablename#
