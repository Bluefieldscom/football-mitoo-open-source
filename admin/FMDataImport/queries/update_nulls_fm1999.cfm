...
--->
<cfquery name="gettables" datasource="fm1999">
	show tables
</cfquery>

<cfloop query="gettables">
	<cfset tablename = #tables_in_fm1999#>
	<cfquery name="getit" datasource="fm1999">
		explain #tablename#
	</cfquery>
	<cfloop query="getit">
		<cfif #getit.null# IS "YES">
			<cfquery name="changeit" datasource="fm1999">
				UPDATE #tablename#
