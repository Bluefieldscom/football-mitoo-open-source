<?php
	...
	function compress_check(){
		$enc = isset($_SERVER["HTTP_ACCEPT_ENCODING"])?$_SERVER["HTTP_ACCEPT_ENCODING"]:NULL;
	    if (headers_sent() || connection_status()!=0 || (isset($GLOBALS["stream"]) && $GLOBALS["stream"]=="xml") || !$GLOBALS["compression"]){
	        return false;
	    }
